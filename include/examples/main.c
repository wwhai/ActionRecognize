...
static void main_ActionRecognize(void);
...
static void main_ActionRecognize(void)
{
  double b_dv[60];
  double label;
  /* Initialize function 'ActionRecognize' input arguments. */
  /* Initialize function input argument 'X'. */
  /* Call the entry-point 'ActionRecognize'. */
  argInit_1x60_real_T(b_dv);
  label = ActionRecognize(b_dv);
}
